...
close all
clc
cd 'D:\Helical Axis\Code'

%% 1. Definition of the symbolic function to calculate uncertainty of theta1, theta2, theta3 (syms)
syms theta kx ky kz e1x e1y e1z e3x e3y e3z real

% kz = sqrt(1-kx^2-ky^2);%because k is mainly about Z-axis
k = [kx, ky, kz]; 
% e1z= sqrt(1-e1x^2-e1y^2);%because e1 is mainly about Z-axis
e1 = [e1x, e1y, e1z];
% e3y= sqrt(1-e3x^2-e3z);%because e3 is mainly about Y-axis
e3 = [e3x, e3y, e3z];
e2 = cross(e3,e1)/sqrt(sum(cross(e3,e1).^2,2));
e2x=e2(1); e2y=e2(2); e2z=e2(3); 
...
ssu_theta1 = subs(ssu_theta1, {kz, e1z, e3y}, {sqrt(1-kx^2-ky^2), sqrt(1-e1x^2-e1y^2), sqrt(1-e3x^2-e3z)})
% Theta2 ------------------------------------------------------------------
...
ssu_theta2 = subs(ssu_theta2, {kz, e1z, e3y}, {sqrt(1-kx^2-ky^2), sqrt(1-e1x^2-e1y^2), sqrt(1-e3x^2-e3z)})
...
ssu_theta3 = subs(ssu_theta3, {kz, e1z, e3y}, {sqrt(1-kx^2-ky^2), sqrt(1-e1x^2-e1y^2), sqrt(1-e3x^2-e3z)})
...
for file = 1:length(C3D_filenames) 
    ...
    theta_v = radtodeg(acos(((R(1,1,:) + R(2,2,:) + R(3,3,:)) ... % Trace of R
...
%         ssu_kz_v = var_z(t);
        ...
        ssu_theta1_res = (interpol(radtodeg(squeeze(double(subs(ssu_theta1, {theta,kx,ky,e1x,e1y,e2x,e2y,e2z,e3x,e3z,...
            ssu_e1x,ssu_e1y,ssu_e1z,ssu_e2x,ssu_e2y,ssu_e2z,ssu_e3x,ssu_e3y,...
            ssu_e3z, ssu_theta, ssu_kx, ssu_ky, ssu_kz}, {theta_v,kx_v,ky_v,...
            e1x_v,e1y_v,e2x_v,e2y_v,e2z_v,e3x_v,e3z_v,ssu_e1x_v,...
        ...
        ssu_theta2_res = interpol(radtodeg(squeeze(double(subs(ssu_theta2, {theta,kx,ky,kz,e1x,e1y,e1z,e2x,e2y,e2z,e3x,e3y,e3z,...
            ssu_e1x,ssu_e1y,ssu_e1z,ssu_e2x,ssu_e2y,ssu_e2z,ssu_e3x,ssu_e3y,...
            ssu_e3z, ssu_theta, ssu_kx, ssu_ky, ssu_kz}, {theta_v,kx_v,ky_v,...
        ...
        ssu_theta3_res = interpol(radtodeg(squeeze(double(subs(ssu_theta3, {theta,kx,ky,kz,e1x,e1y,e1z,e2x,e2y,e2z,e3x,e3y,e3z,...
            ssu_e1x,ssu_e1y,ssu_e1z,ssu_e2x,ssu_e2y,ssu_e2z,ssu_e3x,ssu_e3y,...
            ssu_e3z, ssu_theta, ssu_kx, ssu_ky, ssu_kz}, {theta_v,kx_v,ky_v,...
            kz_v,e1x_v,e1y_v,e1z_v,e2x_v,e2y_v,e2z_v,e3x_v,e3y_v,e3z_v,ssu_e1x_v,...
            ssu_e1y_v,ssu_e1z_v,ssu_e2x_v,ssu_e2y_v,ssu_e2z_v,ssu_e3x_v,ssu_e3y_v,...
