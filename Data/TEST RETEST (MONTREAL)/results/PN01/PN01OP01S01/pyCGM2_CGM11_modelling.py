...
def main(args):
    ...
    btkTools.smartWriter(finalAcqStatic, str(DATA_PATH+finalSettings["Calibration"]["StaticTrial"][:-4]+".c3d"))
    ...
    for trial in manager.dynamicTrials:
        ...
        btkTools.smartWriter(acqGait, str(DATA_PATH+reconstructFilenameLabelled[:-4]+".c3d"))
